...
class promo(models.Model):
    ...
    date = models.DateTimeField(help_text='Date for the promo. If it is year long, put the end date')
...
class resource(models.Model):
    title = models.CharField(max_length=140, help_text='Title for the promo')
    description = models.TextField(blank=True, help_text='Description for the resource')
    date = models.DateTimeField(help_text='Date the resource was created')
